                        ...
                        <div class="col-12">
                          ...
                          <marquee behavior="scroll" direction="left" class="mx-1 my-0" style="margin-top: 7px !important;" onMouseOver="this.stop()" onMouseOut="this.start()">
                            <?php $__currentLoopData = $alerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              ?>
                              <span class="mandatory <?php echo e($random_color); ?> font-weight-700">
                                <?php if(isset($alert->description)): ?>
                                  <?php echo e($alert->description); ?>&emsp; &emsp; &emsp; &emsp; &emsp; &emsp;
                                <?php endif; ?>
                              </span>
                        ...
                        <div class="d-flex align-items-center">
                          <div class="avatar bg-rgba-primary m-0 p-25 mr-75 mr-xl-2">
                            <div class="avatar-content">
                              <img height="40" width="auto" src="<?php echo e(asset('public/assets/img/sidebar/available_belance.jpg')); ?>" />
                            </div>
                          </div>
                          <div class="total-amount">
                            <h6 class="text-dark" style="font-size: 11px; font-weight: 500;">AVAILABLE BALANCE</h6>
                            <h5 class="text-dark mb-0"><?php echo e(isset(Auth::user()->credit) ? Auth::user()->credit : '0'); ?></h5>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="card mb-1">
                        <div class="card-body d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                            <div class="avatar bg-rgba-primary m-0 p-25 mr-75 mr-xl-2">
                              <div class="avatar-content">
                                <img height="40" width="auto" src="<?php echo e(asset('public/assets/img/sidebar/reseller.png')); ?>" />
                              </div>
                            </div>
                            <div class="total-amount">
                              <h6 class="text-dark" style="font-size: 11px; font-weight: 500;">TOTAL RESELLERS</h6>
                              <h5 class="text-dark mb-0"><?php echo e(isset($total_resellers) ? $total_resellers : 0); ?></h5>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card mb-1">
                        <div class="card-body d-flex align-items-center justify-content-between" style="padding-bottom: 38px;">
                          <div class="d-flex align-items-center">
                            <div class="avatar bg-rgba-primary m-0 p-25 mr-75 mr-xl-2">
                              <div class="avatar-content">
                                <img height="40" width="auto" src="<?php echo e(asset('public/assets/img/sidebar/user.png')); ?>" />
                              </div>
                            </div>
                            <div class="total-amount">
                              <h6 class="text-dark" style="font-size: 11px; font-weight: 500;">TOTAL USERS</h6>
                              <h5 class="text-dark mb-0"><?php echo e(isset($total_users) ? $total_users : 0); ?></h5>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card mb-1">
                      <div class="card-body d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                          <div class="avatar bg-rgba-primary m-0 p-25 mr-75 mr-xl-2">
                            <div class="avatar-content">
                              <img height="40" width="auto" src="<?php echo e(asset('public/assets/img/sidebar/campaign.png')); ?>" />
                            </div>
                          </div>
                          <div class="total-amount">
                            <h6 class="text-dark" style="font-size: 11px; font-weight: 500;">TODAY CAMPAIGNS</h6>
                            <h5 class="text-dark mb-0"><?php echo e(isset($total_campaigns) ? $total_campaigns : 0); ?></h5>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="card-body d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                          <div class="avatar bg-rgba-primary m-0 p-15 mr-75 mr-xl-2">
                            <div class="avatar-content">
                              <img height="40" width="auto" src="<?php echo e(asset('public/assets/img/sidebar/total_numbers.jpg')); ?>" />
                            </div>
                          </div>
                          <div class="total-amount">
                            <h6 class="text-dark" style="font-size: 11px; font-weight: 500;">TOTAL NUMBERS TODAY</h6>
                            <h5 class="text-dark mb-0"><?php echo e(isset($total_numbers) ? $total_numbers : 0); ?></h5>
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          <?php if(isset($campaigns[0])): ?>
                            <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                ...
                                <td><?php echo e($campaign->number_count); ?></td>
                                <td>
                                  ...
                                  <?php elseif($campaign->status=="process"): ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    {
      $.getJSON('<?php echo e(route($fetchChartUrl)); ?>', {date_range}, function(response) {
...
<?php echo $__env->make($template, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/digitaltext.live/resources/views/admin/home.blade.php ENDPATH**/ ?>