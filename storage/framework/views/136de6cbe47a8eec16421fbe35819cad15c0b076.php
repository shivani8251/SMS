<?php $__env->startSection('mytitle', 'Settings'); ?>
    ...
    /*---------------------Starting of query for Setting----------------------*/
      ...
      function settingListTable() {
        ...
        $("#setting-list-table").DataTable({
          ...
          order: [],
          ajax: {
              url: "<?php echo e(route('admin.setting.serverSideDataTable')); ?>",
              type: "GET",
              data: {}
          },
          "columns": [
      ...
      $(document).on("click", ".edit-setting-btn", function() {
        let id = $(this).data("id");
        $.get("<?php echo e(route('admin.setting.fetch')); ?>", {id}, function(data) {
          if (data != "")
          {
      ...
      $("#setting-form").submit(function(event) {
        ...
        {
          $.post("<?php echo e(route('admin.setting.save')); ?>", $(this).serialize(), function(data) {
            // console.log(data)
            if (data.status) {
...
<?php echo $__env->make('admin/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\promotup\resources\views/admin/tools/settings/index.blade.php ENDPATH**/ ?>