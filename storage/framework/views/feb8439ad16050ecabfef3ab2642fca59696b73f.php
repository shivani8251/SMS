        ...
        <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
          ...
          <ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-none d-lg-block">
              <a class="nav-link" href="<?php echo e(route('admin.properties')); ?>">
          ...
          <ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-xl-none d-sm-block mt-1">
              <img style="height: 35px; width: auto; margin-bottom: 5px;" src="<?php echo e(asset('assets/img/logo.png')); ?>"><span class="h4"> Property Bird</span>
            </li>
          </ul>
...
</nav><?php /**PATH C:\xampp\htdocs\probird\resources\views/layouts/adminheader.blade.php ENDPATH**/ ?>