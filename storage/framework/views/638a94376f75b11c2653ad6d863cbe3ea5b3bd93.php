<?php
  ...
  $resellerUpdate = (Auth::user()->user_type=="admin") ? 'admin.reseller.update' : 'user.reseller.update';
?>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h6 class="float-left mb-1">EDIT RESELLER</h6>
  ...
  $(function() {
    ...
    $("#reseller-form").submit(function(event) {
      ...
      if (resellerForm.valid())
      {
        $.ajax({
          type: 'POST',
          url: "<?php echo e(route($resellerUpdate)); ?>",
          data: formData,
          dataType: 'json',
          contentType: false,
          cache: false,
          ...
          success: function(data)
          {
            if (data.status) {
              ...
              window.location.href = "<?php echo e(route($resellerIndexUrl)); ?>";
            }
            else
            {
...
<?php echo $__env->make($template, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/programmicsdev/public_html/emp/proj/digitaltext.sms/resources/views/admin/resellers/edit.blade.php ENDPATH**/ ?>