                  ...
                  <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                    <div class="card-header pb-1">
                      <div class="card-title">
                        <h4 class="text-center mb-2"><?php echo e(__('Users/Resellers Login')); ?></h4>
                      </div>
                    </div>
                    <div class="card-body">
                      ...
                      <form action="<?php echo e(route('user.login.post')); ?>" method="POST">
                        ...
                        <div class="form-group mb-50">
                          <label class="text-bold-600" for="username"><?php echo e(__('User ID')); ?></label>
...
unset($__errorArgs, $__bag); ?> <?php $__errorArgs = ['email_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="username" value="<?php echo e(old('username') ? old('username') : old('email_id')); ?>" placeholder="Email address" required autocomplete="username" autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                  <img class="img-fluid" src="<?php echo e(asset('public/assets/images/logo/login.png')); ?>" alt="branding logo">
                </div>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/digitaltext.live/resources/views/user/login.blade.php ENDPATH**/ ?>