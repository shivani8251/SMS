    ...
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto">
        <a class="navbar-brand" href="">
          ...
          <h5 class="brand-text mb-0 pl-0 text-white" style="font-size: 13px !important;"> {{isset($business_name) ? $business_name : ''}}</h5>
        </a>
      </li>
    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
      ...
      <li class="nav-item" id="news-menu">
        <a href="{{ route('user.news.index') }}">
          <img height="25" width="auto" src="{{ asset('public/assets/img/sidebar/news.png') }}" />
      ...
      @if(Auth::user()->user_type=='reseller')
        <li class="nav-item" id="tree-view-menu">
          <a href="{{ route('user.treeview.index') }}">
            <img height="25" width="auto" src="{{ asset('public/assets/img/sidebar/tree_view.png') }}" />
