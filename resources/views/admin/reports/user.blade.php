@php
  ...
  $serverSideDataTable = (Auth::user()->user_type=="admin") ? 'admin.user.report.dataTable' : 'user.user.report.dataTable';
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    <h6 class="mb-1 float-left">LIST OF ALL USER CREDIT REPORT</h6>
                    <div class="float-right">
                      <a href="{{ route($createCreditPageUrl, 'user') }}" class="btn btn-sm btn-primary"><i class="bx bx-plus"></i> ADD CREDIT</a>
                    </div>
                  </div>
                  <div class="col-12">
                    <hr />
...
<script>
  $(function() {
    ...
    function userListTable(user = 'All', date_range = '') {
