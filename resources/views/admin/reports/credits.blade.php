@php
  ...
  $serverSideDataTable = (Auth::user()->user_type=="admin") ? 'admin.credits.dataTable' : 'user.credits.dataTable';
@endphp

@extends($template)

@section('mytitle', 'Credits')
@section('content')
<!-- BEGIN: Content-->
<style type="text/css">
  table th {
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    <h6 class="mb-1 float-left">LIST OF ALL TRANSACTIONS</h6>
                  </div>
                  <div class="col-12">
                    <hr />
                    <form id="search-form">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <select id="user-filter" class="form-control select2 filter-select2" data-placeholder="Select User">
                              <option value="All">All Members/Campaigns</option>
                              @foreach($users as $user)
                                <option value="{{$user->user_unique_id}}">{{$user->username.' ('.$user->user_unique_id.') ('.ucfirst($user->user_type).')'}}</option>
                              @endforeach
                            </select>
                          </div>
                        </div>
