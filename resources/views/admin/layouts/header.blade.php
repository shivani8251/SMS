            ...
            <a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right pb-0">
                <a class="dropdown-item" href="{{ route('admin.profile.edit') }}">
                   <img height="25" width="auto" src="{{ asset('public/assets/img/sidebar/profile.png') }}" /> &nbsp;&nbsp;{{ __('Profile') }}
                </a>
                <a class="dropdown-item" data-toggle="modal" data-target="#change-password-modal" href="javascript:void(0);">
                  <img height="25" width="auto" src="{{ asset('public/assets/img/sidebar/reset_password.png') }}" /> &nbsp;&nbsp; {{ __('Change Password') }}
                </a>
                <a class="dropdown-item" data-toggle="modal" data-target="#update-credit-modal" href="javascript:void(0);">
                  <img height="25" width="auto" src="{{ asset('public/assets/img/sidebar/update_credit.png') }}" /> &nbsp;&nbsp; {{ __('Add Credit Balance') }}
                </a>
                <div class="dropdown-divider mb-0"></div>
                <a class="dropdown-item" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                  <img height="25" width="auto" src="{{ asset('public/assets/img/sidebar/power.png') }}" /> &nbsp;&nbsp; {{ __('Logout') }}
                </a>
...
<script>
  ...
  $(function() {
    ...
    $("#update-credit-form").submit(function(event) {
      ...
      {
        $("#submit-credit-btn").prop('disabled', true);
        $.post("{{ route('admin.credit.update') }}", $(this).serialize(), function(data) {
          ...
          $("#submit-credit-btn").prop('disabled', false);
        }, 'json');
      }
    });
