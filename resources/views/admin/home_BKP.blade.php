              ...
              <div class="col-12">
                <div class="row">
                  @if(Auth::user()->user_type!='admin')
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-12 pl-0 pr-1">
                      <div class="card mb-1">
                        <div class="card-body d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                            <div class="avatar bg-rgba-primary m-0 p-25 mr-75 mr-xl-2">
                  ...
                  @endif
                  <div class="col-xl-3 col-lg-3 col-md-3 col-12 {{Auth::user()->user_type=='admin' ? 'pl-1' : 'pl-0'}} pr-1">
                    <div class="card mb-1">
                      <div class="card-body d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                          <div class="avatar bg-rgba-primary m-0 p-25 mr-75 mr-xl-2">
                    ...
                    <div class="card mb-1">
                      <div class="card-body d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                          <div class="avatar bg-rgba-primary m-0 p-25 mr-75 mr-xl-2">
                            <div class="avatar-content">
                              <i class="bx bxl-whatsapp text-dark" height="40"></i>
                            </div>
                          </div>
                          <div class="total-amount">
                            <h6 class="text-dark" style="font-size: 11px; font-weight: 500;">TOTAL CAMPAIGNS</h6>
                  ...
                  @if(Auth::user()->user_type!='user')
                    <div class="col-xl-3 col-lg-3 col-md-3 col-12 {{Auth::user()->user_type=='admin' ? 'pl-0' : 'pl-1'}} pr-1">
                      <div class="card mb-1">
                        <div class="card-body d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                            <div class="avatar bg-rgba-primary m-0 p-25 mr-75 mr-xl-2">
                              <div class="avatar-content">
                                <i class="bx bxs-group text-dark" height="40"></i>
                              </div>
                            </div>
                            <div class="total-amount">
                      ...
                      <div class="card mb-1">
                        <div class="card-body d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                            <div class="avatar bg-rgba-primary m-0 p-25 mr-75 mr-xl-2">
                              <div class="avatar-content">
                                <i class="bx bx-group text-dark" height="40"></i>
                              </div>
                            </div>
                            <div class="total-amount">
                        ...
                        <tbody>
                          @if(isset($campaigns[0]))
                            @foreach($campaigns as $key => $campaign)
                              <tr>
                                <td>{{++$key}}</td>
                                <td>{{$campaign->campaign_name.' ('.$campaign->campaign_unique_id.')'}}</td>
          ...
          tooltip: {
              ...
              y: {
                  formatter: function(e) {
                      return void 0 !== e ? 'Rs. '+e.toFixed(2) : e
                  }
              }
          }
        };
