@php
  ...
  $saveUrl = (Auth::user()->user_type=="admin") ? 'admin.user.credit.save' : 'user.user.credit.save';
@endphp
              ...
              <div class="card-body">
                <form method="post" id="add-credit-form" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <div class="form-group">
                        <label class="form-control-label">Per SMS price (In Paise)<span class="text-danger">*</span> </label>
