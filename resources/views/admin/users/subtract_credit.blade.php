@php
  ...
  $saveUrl = (Auth::user()->user_type=="admin") ? 'admin.user.credit.subtract' : 'user.user.credit.subtract';
@endphp
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="float-right">
                  <a href="{{ route($userIndexUrl) }}" class="btn btn-sm btn-primary"><i class="bx bx-left-arrow-alt"></i> Back</a>
                </div>
              </div>
              <div class="card-body">
